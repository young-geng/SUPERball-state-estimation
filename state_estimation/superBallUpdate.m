...
%         rangingMeasures = zeros(size(rangingMeasures));
        rangingMeasures(isInternal) = 0; %TODO: Add barlength back into simulator
        rangingMeasures(isBar) = 1.7 + 3.8; %TODO: Add barlength back into simulator
...
%         superBallDynamicsPlot.nodePoints = actualNodes ;
        ...
        goodLengths = rangingMeasures(isNewMeasurement) - 3.8;
        goodLengths = -goodLengths;
