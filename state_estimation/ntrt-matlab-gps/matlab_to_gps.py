...
def state_cb(msg):
    ...
    for idx in xrange(6):
        ...
        state.pos1.x = tmp_node_pos[6*idx]
        state.pos1.y = tmp_node_pos[6*idx + 1]
        state.pos1.z = tmp_node_pos[6*idx + 2]
        state.pos2.x = tmp_node_pos[6*idx + 3]
        state.pos2.y = tmp_node_pos[6*idx + 4]
        state.pos2.z = tmp_node_pos[6*idx + 5]

        node_pos[2*idx] = np.array([state.pos1.x,state.pos1.y,state.pos1.z])
        node_pos[2*idx+1] = np.array([state.pos2.x,state.pos2.y,state.pos2.z])
